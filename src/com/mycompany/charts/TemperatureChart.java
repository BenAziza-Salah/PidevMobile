...
import com.mycompany.charts.AbstractDemoChart;
...
public class TemperatureChart extends AbstractDemoChart {
   ...
   */
  public Form execute() {
    double[] minValues = new double[] { -50, -45, -35, -30, -25, -20, -10, -9, -5, 0, 12,26};
    double[] maxValues ={ 7, 11, 12, 24, 28, 33, 35, 37, 36, 1, 0, -12, -11,-7};

      ArrayList<Article> list= ServiceArticle.getInstance().getAllArticles();
     for(Article r : list ){
       maxValues[list.indexOf(r)]=r.getId_article();
       
   }
    XYMultipleSeriesDataset dataset = new XYMultipleSeriesDataset();
    RangeCategorySeries series = new RangeCategorySeries("Article Par rate");
    ...
    setChartSettings(renderer, "", "", "", 0.5, 12.5,
    ...
    renderer.setYLabels(10);
        ...
        renderer.addXTextLabel(10, "4");
        renderer.addXTextLabel(12, "5");
