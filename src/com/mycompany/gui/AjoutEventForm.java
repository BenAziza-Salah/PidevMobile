...
//        addStringValue("SujetRec", SujetRec);
      ...
      /*  TextField Date = new TextField("", "Entrer Date");
        ...
        Button btnAjouterEvent = new Button("Ajouter");
        addStringValue("", btnAjouterEvent);

       // this.add("Date naissance : ").add(DATENAISSANCE);

//On click button event
        btnAjouterEvent.addActionListener((e) -> {

            if (Description.getText() == "") {//idCategorie,Nom,Description,Lieux,Prix
                ...
                try {
                    ...
                    Event r = new Event(idCategorie.getText(),
                            Nom.getText(),
                            Description.getText(),
                            Lieux.getText(),
                            ddd.format(dated),
                            (float) Float.parseFloat(Prix.getText()));

                    System.out.println("Data ==> " + r);

                    ServiceEvent.getInstance().addEvent(r);
                    iDialog.dispose();
                    refreshTheme();
