 ...
 * @author yassin
 */
public class AfficherAdmin extends BaseForm {

    Form current;

    public AfficherAdmin(Resources res) {
        ...
        RadioButton mesListes = RadioButton.createToggle("Admin", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Autres", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Ajouter Admin", barGroup);
        ...
        ArrayList<Admin> list = ServiceAdmin.getInstance().AffichageAdmin();
        for (Admin rec : list) {
    ...
    private void addButton(Image img, Admin rec, Resources res) {
        ...
        Label idAdminTxt = new Label("id :" + rec.getId(), "NewsTopLine2");
        Label NomTxt = new Label("Nom :" + rec.getNom(), "NewsTopLine2");
        Label PrenomTxt = new Label("Prenom :" + rec.getPrenom(), "NewsTopLine2");
        Label UsernameTxt = new Label("Username :" + rec.getUsername(), "NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
         Dialog dig = new Dialog("Suppression");
            if (dig.show("Suppression", "Vous voulez supprimer cette Event ?", "Annuler", "Oui")) {
                ...
                if (ServiceAdmin.getInstance().DeleteAdmin(rec.getId())) {
                    new AfficherAdmin(res).show();
                }
            }
        });
        ...
        lModifier.addPointerPressedListener(l -> {
          ...
          new ModifierAdmin(res, rec).show();
        });

        cnt.add(BorderLayout.CENTER, BoxLayout.encloseY(
                BoxLayout.encloseX(idAdminTxt),
