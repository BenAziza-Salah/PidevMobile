...
public class AjoutCategorieForm extends BaseForm {
    ...
    public AjoutCategorieForm(Resources res) {
        ...
        RadioButton liste = RadioButton.createToggle("Event", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Add Categorie", barGroup);
...
//On click button event
        btnAjouterEvent.addActionListener((e) -> {
            ...
            if (Type.getText() == "") {//idCategorie,Nom,Description,Lieux,Prix
                ...
                try {
                    ...
                    Categorie r = new Categorie(Type.getText());

                    System.out.println("Data ==> " + r);

                    ServiceCategorie.getInstance().addCategorie(r);
                    iDialog.dispose();
                    refreshTheme();
