...
public class editCat extends Form {
    ...
    public editCat(Form previous, Categoriearticle r) {
 ...
 TextField tfnomcat = new TextField(r.getNomcat());
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((tfnomcat.getText().length() == 0) ) {
                    ...
                    try {
                        ...
                        r.setNomcat(tfnomcat.getText());
                       
                       
                        if( ServiceCat.getInstance().editcat(r)){
