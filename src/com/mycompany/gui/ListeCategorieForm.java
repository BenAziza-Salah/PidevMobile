 ...
 * @author yassin
 */
public class ListeCategorieForm extends BaseForm {

    Form current;

    public ListeCategorieForm(Resources res) {
        ...
        ArrayList<Categorie> list = ServiceCategorie
                .getInstance().AffichageCategorie();
