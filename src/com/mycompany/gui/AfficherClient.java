 ...
 * @author SALAH
 */
public class AfficherClient extends BaseForm{
    
      Form current;

    public AfficherClient(Resources res) {
       super("Newsfeed", BoxLayout.y());
        ...
        Label s1 = new Label();
        Label s2 = new Label();
        addTab(swipe, s1, res.getImage("client.jpg"), "", "", res);
        ...
        RadioButton mesListes = RadioButton.createToggle("Client", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Autres", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Ajouter Client", barGroup);
        ...
        ArrayList<Client> list = ServiceClient.getInstance().AffichageClient();
        for (Client rec : list) {
    ...
    private void addButton(Image img, Client rec, Resources res) {
        ...
        Label idClientTxt = new Label("id :" + rec.getIdc(), "NewsTopLine2");
        Label NomTxt = new Label("Nom :" + rec.getNom(), "NewsTopLine2");
        Label PrenomTxt = new Label("Prenom :" + rec.getPrenom(), "NewsTopLine2");
        Label AddressTxt = new Label("Adresse :" + rec.getAddress(), "NewsTopLine2");
        Label NumTelTxt = new Label("Numero de Telephone :" + rec.getNumtelc(), "NewsTopLine2");
        Label EmailTxt = new Label("Email :" + rec.getEmail().toString(), "NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
         Dialog dig = new Dialog("Suppression");
            if (dig.show("Suppression", "Vous voulez supprimer cette Event ?", "Annuler", "Oui")) {
                ...
                if (ServiceClient.getInstance().DeleteClient(rec.getIdc())) {
                    new AfficherClient(res).show();
                }
            }
        });
        ...
        lModifier.addPointerPressedListener(l -> {
          ...
          new ModifierClient(res, rec).show();
        });

        cnt.add(BorderLayout.CENTER, BoxLayout.encloseY(
                BoxLayout.encloseX(idClientTxt),
